...
if Input.GetKeyBindButtonDown(KeyBinds.OpenLoadout) then
	...
	-- 		if raycast.transform.gameObject.GetComponent(ResupplyCrate) ~= nil then
	-- 			print("Player used a resupply crate to get a new loadout")
	-- 			self.button.transform.gameObject.SetActive(true)
	-- 			self.DeployText.text = "Get new Loadout"
	-- 		end
	-- 	end
	-- end
	end
